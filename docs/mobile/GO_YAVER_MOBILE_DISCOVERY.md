...
Before this change, the mobile Hot Reload tab in [mobile/app/(tabs)/apps.tsx](<../../mobile/app/(tabs)/apps.tsx>) was reading:
...
- [mobile/app/(tabs)/apps.tsx](<../../mobile/app/(tabs)/apps.tsx>)
...
- [desktop/agent/mobile_projects.go](../../desktop/agent/mobile_projects.go)
...
- [desktop/agent/mobile_projects_test.go](../../desktop/agent/mobile_projects_test.go)
...
Also relevant in [desktop/agent/mobile_projects_test.go](../../desktop/agent/mobile_projects_test.go):
...
Also relevant in [desktop/agent/classify_test.go](../../desktop/agent/classify_test.go):
...
- [mobile/ios/Yaver/Info.plist](../../mobile/ios/Yaver/Info.plist) was already dirty in the worktree and was not modified by me for this task.
