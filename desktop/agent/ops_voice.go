	...
	registerOpsVerb(opsVerbSpec{
		...
		Schema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"stt_provider":            map[string]interface{}{"type": "string", "enum": []string{"openai", "deepgram", "assemblyai", "on-device"}},
				"tts_provider":            map[string]interface{}{"type": "string", "enum": []string{"openai", "deepgram", "cartesia", "elevenlabs", "device"}},
