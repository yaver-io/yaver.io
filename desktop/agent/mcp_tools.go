...
func (s *HTTPServer) getMCPToolsList() interface{} {
	...
	platformTools := []map[string]interface{}{
		...
		{"name": "machine_onboarding_status", "description": "Show whether OpenAI, GitHub, and GitLab are configured on this machine or another owned Yaver machine. Reports OpenAI API key readiness plus Git clone and CI/deploy token state.", "inputSchema": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"device_id": map[string]interface{}{"type": "string", "description": "Optional remote device ID"}}}},
		{"name": "machine_onboarding_apply", "description": "Configure OpenAI, GitHub, and GitLab onboarding on the local or remote Yaver machine. Stores OpenAI in vault, and for GitHub/GitLab can write clone credentials plus CI/deploy tokens.", "inputSchema": map[string]interface{}{"type": "object", "properties": map[string]interface{}{"device_id": map[string]interface{}{"type": "string", "description": "Optional remote device ID"}, "openai_api_key": map[string]interface{}{"type": "string"}, "github_token": map[string]interface{}{"type": "string"}, "gitlab_token": map[string]interface{}{"type": "string"}, "gitlab_host": map[string]interface{}{"type": "string", "description": "Defaults to gitlab.com"}, "apply_clone": map[string]interface{}{"type": "boolean", "description": "Write clone/pull credentials (default true)"}, "apply_ci_token": map[string]interface{}{"type": "boolean", "description": "Write CI/deploy vault token (default true)"}, "notes": map[string]interface{}{"type": "string"}}}},
		// Cloud provisioning
