...
func (s *HTTPServer) getMCPToolsList() interface{} {
	...
	platformTools := []map[string]interface{}{
		...
		{"name": "runner_auth_setup", "description": "High-level runner bootstrap for a local or remote Yaver machine: install the runner if missing, report whether subscription OAuth is still pending, and register Yaver as an MCP server inside the runner when supported. For Claude Code/Codex, finish auth with runner_auth_browser_start or runner_auth_credentials_import. Provider credentials here are for OpenCode/GLM only.", "inputSchema": map[string]interface{}{"type": "object", "required": []string{"runner"}, "properties": map[string]interface{}{"device_id": map[string]interface{}{"type": "string", "description": "Optional remote device ID"}, "runner": map[string]interface{}{"type": "string", "enum": []string{"claude", "claude-code", "codex", "opencode", "glm"}}, "openai_api_key": map[string]interface{}{"type": "string", "description": "OpenCode provider credential only."}, "anthropic_api_key": map[string]interface{}{"type": "string", "description": "OpenCode provider credential only."}, "glm_api_key": map[string]interface{}{"type": "string", "description": "OpenCode/GLM provider credential."}, "zai_api_key": map[string]interface{}{"type": "string", "description": "OpenCode/GLM provider credential."}, "notes": map[string]interface{}{"type": "string"}, "install_if_missing": map[string]interface{}{"type": "boolean", "description": "Default true."}, "codex_login": map[string]interface{}{"type": "boolean", "description": "Default true for Codex; use browser auth for ChatGPT Plus/Pro OAuth."}, "setup_mcp": map[string]interface{}{"type": "boolean", "description": "Default true. Registers Yaver as an MCP server in the runner when supported."}, "allow_install_only": map[string]interface{}{"type": "boolean", "description": "Return a soft success when the CLI is installed but auth is still pending."}}}},
