...
func (s *HTTPServer) getMCPToolsList() interface{} {
	...
	platformTools := []map[string]interface{}{
		...
		{"name": "runner_auth_set", "description": "Legacy vault-backed provider auth for local or remote setup. Do not use API-key fields for Claude Code or Codex plan auth; prefer runner_auth_browser_start for fresh OAuth or runner_auth_credentials_import for an already-signed-in user-owned box. Optional device_id writes to another owned Yaver machine.", "inputSchema": map[string]interface{}{"type": "object", "required": []string{"runner"}, "properties": map[string]interface{}{"device_id": map[string]interface{}{"type": "string", "description": "Optional remote device ID"}, "runner": map[string]interface{}{"type": "string", "enum": []string{"claude", "claude-code", "codex", "opencode", "glm"}}, "openai_api_key": map[string]interface{}{"type": "string", "description": "Legacy/provider field; not for Codex plan OAuth."}, "anthropic_api_key": map[string]interface{}{"type": "string", "description": "Legacy/provider field; not for Claude Code plan OAuth."}, "anthropic_auth_token": map[string]interface{}{"type": "string"}, "claude_code_oauth_token": map[string]interface{}{"type": "string"}, "glm_api_key": map[string]interface{}{"type": "string"}, "zai_api_key": map[string]interface{}{"type": "string"}, "notes": map[string]interface{}{"type": "string"}}}},
		{"name": "runner_auth_setup", "description": "High-level runner bootstrap for a local or remote Yaver machine: install the runner if missing, report whether plan OAuth is still pending, and register Yaver as an MCP server inside the runner when supported. For Claude Code/Codex, finish auth with runner_auth_browser_start or runner_auth_credentials_import; API keys are not the plan-auth path.", "inputSchema": map[string]interface{}{"type": "object", "required": []string{"runner"}, "properties": map[string]interface{}{"device_id": map[string]interface{}{"type": "string", "description": "Optional remote device ID"}, "runner": map[string]interface{}{"type": "string", "enum": []string{"claude", "claude-code", "codex", "opencode", "glm"}}, "openai_api_key": map[string]interface{}{"type": "string", "description": "Legacy/provider field; ignored for Codex plan OAuth."}, "anthropic_api_key": map[string]interface{}{"type": "string", "description": "Legacy/provider field; ignored for Claude Code plan OAuth."}, "anthropic_auth_token": map[string]interface{}{"type": "string"}, "claude_code_oauth_token": map[string]interface{}{"type": "string"}, "glm_api_key": map[string]interface{}{"type": "string"}, "zai_api_key": map[string]interface{}{"type": "string"}, "notes": map[string]interface{}{"type": "string"}, "install_if_missing": map[string]interface{}{"type": "boolean", "description": "Default true."}, "codex_login": map[string]interface{}{"type": "boolean", "description": "Default true for Codex; starts no API-key login. Use browser auth for ChatGPT Plus/Pro OAuth."}, "setup_mcp": map[string]interface{}{"type": "boolean", "description": "Default true. Registers Yaver as an MCP server in the runner when supported."}, "allow_install_only": map[string]interface{}{"type": "boolean", "description": "Return a soft success when the CLI is installed but auth is still pending."}}}},
