...
export const ACTION_CATALOG: ActionSpec[] = [
  ...
  { id: "device.doctor", description: "Deep connectivity doctor for one device: Convex heartbeat, raw ping/IP layer, private network, Yaver HTTP, relay/LAN, runner auth, and resources.", tier: "READ_ONLY", needsDevice: true, via: "mcp", mcpTool: "machine_doctor" },
